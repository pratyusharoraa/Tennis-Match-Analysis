...
def main():
    ...
    output_video_frames = player_tracker.draw_bboxes(output_video_frames, ball_detections)
    ...
    output_video_frames = mini_court.draw_points_on_mini_court(output_video_frames, ball_mini_court_detections, color=(255,0,255))
